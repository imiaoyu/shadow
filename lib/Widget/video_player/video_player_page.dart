...
import 'package:shadow/Utils/VideoPlayerUtils/temp_value.dart';
import 'package:shadow/Utils/VideoPlayerUtils/video_player_utils.dart';

import 'video_player_bottom.dart';
import 'video_player_center.dart';
import 'video_player_gestures.dart';
import 'video_player_top.dart';

class VideoPlayerPages extends StatefulWidget {
  const VideoPlayerPages({Key? key}) : super(key: key);
  @override
  _VideoPlayerPageState createState() => _VideoPlayerPageState();
}

class _VideoPlayerPageState extends State<VideoPlayerPages> {
  // 是否全屏
