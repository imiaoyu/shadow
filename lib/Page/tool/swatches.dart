...
import 'package:shadow/Utils/GeneratorUtil.dart';
...
class SwatchesWidget extends StatefulWidget {
  const SwatchesWidget({Key? key}) : super(key: key);

  @override
  _SwatchesWidgetState createState() => _SwatchesWidgetState();
}
...
class _SwatchesWidgetState extends State<SwatchesWidget> {
  List<Color> colors = [];
